...
if ( ! function_exists( 'iscp_get_customizer_defaults' ) ) {
	...
	function iscp_get_customizer_defaults() {
		return array(
			...
			'iscp_hero_headline'                => __( 'Business Software, Cloud and AI for Growing Organizations', 'iscp' ),
			'iscp_hero_subtitle'                => __( 'Indian Servers builds SaaS products, custom software, managed cloud, cybersecurity and AI systems for schools, SMEs, enterprises and global teams.', 'iscp' ),
			'iscp_hero_primary_cta_text'        => __( 'Explore Products', 'iscp' ),
			'iscp_hero_primary_cta_url'         => '/products/',
			'iscp_hero_secondary_cta_text'      => __( 'View Services', 'iscp' ),
