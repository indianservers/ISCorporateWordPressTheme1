...
if ( ! function_exists( 'iscp_get_customizer_defaults' ) ) {
	...
	function iscp_get_customizer_defaults() {
		return array(
			...
			'iscp_hero_eyebrow'                 => __( 'Trusted by 2,200+ businesses across 6 countries', 'iscp' ),
			'iscp_hero_headline'                => __( 'Software That Works. AI That Thinks. Cloud That Scales.', 'iscp' ),
			'iscp_hero_subtitle'                => __( 'Indian Servers builds custom software, SaaS products, AI systems and managed cloud infrastructure for businesses in India, USA, UAE, Australia and South Africa.', 'iscp' ),
			'iscp_hero_primary_cta_text'        => __( 'Get a Free Estimate', 'iscp' ),
			'iscp_hero_primary_cta_url'         => '/products/',
			'iscp_hero_secondary_cta_text'      => __( 'Explore Our Products', 'iscp' ),
			'iscp_hero_secondary_cta_url'       => '/services/',
			'iscp_hero_badge_1'                 => __( '2200+ Clients', 'iscp' ),
			'iscp_hero_badge_2'                 => __( 'Products + Services', 'iscp' ),
			'iscp_hero_badge_3'                 => __( 'India, Dubai, USA', 'iscp' ),
			'iscp_hero_badge_4'                 => __( 'Cloud + Security', 'iscp' ),
			'iscp_hero_visual_enabled'          => true,
			'iscp_primary_color'                => '#0f5bd6',
			'iscp_accent_color'                 => '#00a4ef',
			'iscp_background_color'             => '#ffffff',
			'iscp_surface_color'                => '#f8fafc',
			'iscp_text_color'                   => '#0f172a',
			'iscp_muted_text_color'             => '#64748b',
			'iscp_dark_section_background'      => '#061733',
			...
			'iscp_scroll_progress_enabled'      => true,
