...
<?php while ( have_posts() ) : ?>
	...
	<section class="iscp-section iscp-single-hero">
		<div class="iscp-container">
			<p class="iscp-eyebrow"><?php esc_html_e( 'Service', 'iscp' ); ?></p>
	...
	<article class="iscp-container iscp-content-layout iscp-cpt-single">
		...
		<div class="iscp-entry-content">
			...
			if ( $iscp_content ) {
				...
				echo wp_kses_post( iscp_get_cpt_default_content( 'iscp_service', get_the_title() ) );
			}
			?>
		</div>
		<div class="iscp-single-cta">
			<h2><?php esc_html_e( 'Ready to discuss this service?', 'iscp' ); ?></h2>
			<a class="iscp-btn iscp-btn-primary" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"><?php esc_html_e( 'Contact Us', 'iscp' ); ?></a>
		</div>
	</article>
<?php endwhile; ?>
...
if ( $iscp_related->have_posts() ) :
	...
	<section class="iscp-section iscp-section-alt">
		<div class="iscp-container">
			<div class="iscp-section-heading"><h2><?php esc_html_e( 'Related Services', 'iscp' ); ?></h2></div>
